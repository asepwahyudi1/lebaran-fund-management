<div>
                            ...
                            <div class="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-3xl p-5 shadow-sm hover:shadow-md transition">
                                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                                    ...
                                    <div class="flex sm:flex-col items-center justify-between sm:justify-start gap-4 sm:items-end w-full sm:w-auto">
                                        <!-- Delete Button -->
                                        <button wire:click="removeItem({{ $item['package']->id }})" class="p-2 text-gray-400 hover:text-rose-500 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/20 rounded-xl transition sm:order-first" title="Hapus Paket">
                                        ...
                                        <div class="flex items-center gap-1.5 bg-gray-50 dark:bg-gray-800 border border-gray-150 dark:border-gray-700 rounded-xl p-1 shrink-0">
                                            <button wire:click="updateQuantity({{ $item['package']->id }}, -1)" class="w-7 h-7 flex items-center justify-center text-gray-500 hover:text-gray-900 dark:hover:text-white hover:bg-white dark:hover:bg-gray-700 rounded-lg transition font-bold text-sm">
                                                -
                                            </button>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-3xl p-6 shadow-sm">
                            ...
                            <div class="space-y-4">
                                ...
                                <button wire:click="checkout" class="w-full mt-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-850 text-white text-center font-bold text-sm rounded-2xl shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30 transition duration-200 flex items-center justify-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                                    Lanjut ke Checkout
    ...
    <div x-data="{ showModal: @entangle('isOpenCheckoutModal') }"
        ...
        <div class="bg-white dark:bg-gray-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-gray-150 dark:border-gray-800 relative">
            <!-- Close -->
            <button @click="showModal = false" class="absolute top-4 right-4 p-1.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-400 hover:text-gray-600 transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            ...
            <div class="flex items-center gap-3">
                <button @click="showModal = false" class="flex-1 py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    Batal
                </button>
                <button wire:click="confirmCheckout" class="flex-1 py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-2xl shadow-md transition">
                    Checkout Sekarang
                </button>
            </div>
        </div>
