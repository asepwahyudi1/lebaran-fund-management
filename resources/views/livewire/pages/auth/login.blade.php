...
<div>
    ...
    <form wire:submit="login">
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Email / Nomor Telepon')" />
        ...
        <div class="mt-4">
            ...
            <div x-data="{ showPassword: false }" class="relative mt-1">
                ...
                <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-3 flex items-center text-gray-400 hover:text-gray-655 dark:hover:text-gray-300 focus:outline-none">
                    <!-- eye open -->
